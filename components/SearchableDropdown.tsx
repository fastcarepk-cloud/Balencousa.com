  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute z-50 w-full mt-2 bg-white border-2 border-gray-200 rounded-lg shadow-lg max-h-64 overflow-hidden">
            {/* Search Input */}
            <div className="p-3 border-b border-gray-100">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 border-gray-200 focus:border-pink-500 focus:ring-pink-200"
                />
              </div>
            </div>
            ...
            <div className="max-h-48 overflow-y-auto">
              {filteredOptions.length > 0 ? (
                ...
                <div className="px-4 py-3 text-gray-500 text-center">No results found for "{searchTerm}"</div>
              )}
            </div>
          </div>
        )}
